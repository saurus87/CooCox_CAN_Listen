/**
  ...
  *          n between two SPIs in simplex mode and performs a data buffer tr
  *          ansfer from SPI_MASTER to SPI_SLAVE. SPI_MASTER and SPI_SLAVE ca
  *          n be SPI1 and SPI2 or SPI3 and SPI2, depending on the STMicroele
  *          ctronics EVAL board you are using. This example poll some flags
  *          to transmit or receive data other than using interrupts.
  *******************************************************************************
  */
